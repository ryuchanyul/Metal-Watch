...
//
// limit=10000: TE가 매시간 9종 × 24 = 216행/일 적재하므로,
// 자주 갱신되지 않는 종목(W_WC, W_WO3, Mo는 KOMIS만 매일 1행)이
// 최근 X행 안에 안 들어올 수 있어 충분히 큰 limit 필요.
// 한 달치 = KOMIS 16×30 + TE 9×24×30 ≈ 7,000행. 10000으로 한 달 커버.
export async function fetchLatestPrices() {
  assertEnv();
  const url = `${SUPABASE_URL}/rest/v1/price_snapshots?select=symbol,usd_per_kg,raw_value,raw_unit,source,collected_at&order=collected_at.desc&limit=10000`;
